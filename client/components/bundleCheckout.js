              ...
              <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
                ...
                <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                  <p style="Margin-top: 0;Margin-bottom: 20px;">
                        ...
                        <div style="Margin-left: 20px;Margin-right: 20px;">
                <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                  <p style="Margin-top: 0;Margin-bottom: 0;text-align: center;">Your campaign has been selected and added to contract # ${contractHash}!.<br />
          Please make payment now to activate contract.</p><p style="Margin-top: 20px;Margin-bottom: 20px;text-align: center;">&nbsp;</p>
                </div>
              </div>
